**Current build status:** master: [![Build Status](https://travis-ci.org/tecknicaltom/gentoo-genealogy-overlay.svg?branch=master)](https://travis-ci.org/tecknicaltom/gentoo-genealogy-overlay)
